...
int main(int argc, char* argv[])
{
	if (argc != 4 && argc != 5)
	{
		std::cout << "Usage: magnify_segments input.tet.vtk input.tri.seg.vtk output.tet.vtk scale" << std::endl;
		return -1;
	}
...
//    {
//        size2 = 2.0 * half_dis;
//        v1m = glm::vec3(v_mid.x + dir2.x*size2, v_mid.y + dir2.y*size2, v_mid.z + dir2.z*size2);
//        v2m = glm::vec3(v_mid.x - dir2.x*size2, v_mid.y - dir2.y*size2, v_mid.z - dir2.z*size2);
//        cube2[0] = glm::vec3(v1m.x + dir3.x*size2, v1m.y + dir3.y*size2, v1m.z + dir3.z*size2);
//        cube2[1] = glm::vec3(v2m.x + dir3.x*size2, v2m.y + dir3.y*size2, v2m.z + dir3.z*size2);
//        cube2[2] = glm::vec3(v2m.x - dir3.x*size2, v2m.y - dir3.y*size2, v2m.z - dir3.z*size2);
//        cube2[3] = glm::vec3(v1m.x - dir3.x*size2, v1m.y - dir3.y*size2, v1m.z - dir3.z*size2);
//    }
	///////////////////////////////////////////////
	// parametrize vertex
...
//	update_vertices(triMesh);
	...
	std::cout << "-------point_segment0_tet---------" << std::endl;
    for (size_t i = 0; i < point_segment0_tet.size(); i++)
    {
        std::cout << point_segment0_tet.at(i) << std::endl;
    }
	return 0;
}

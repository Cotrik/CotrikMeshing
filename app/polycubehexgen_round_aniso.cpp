...
//    int Func = 1;
    ...
    polycubeTriMesh.AdjustPolycubeSurfaceToHoldAllSmallCubesVolume1_ROUND(delta, polycubeTriMesh.m_minVertex);
    polycubeTriMesh.AddCompensation();
    polycubeTriMesh.ModifyPatchesPosition_ROUND(delta);

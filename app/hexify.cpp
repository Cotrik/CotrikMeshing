...
int HexifyMesh(int argc, char* argv[]);

int main(int argc, char* argv[])
{
	return HexifyMesh(argc, argv);
}
...
//	float cubesize = 0.08f;
	...
	polycubeTetMesh.GenerateHexahedralMesh(origTetMesh, strOutputPolyHexFileName.c_str(), strOutputResultHexFileName.c_str(), delta, dir);

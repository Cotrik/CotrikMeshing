...
int main(int argc, char* argv[])
{
	...
	MeshFileReader orgTriMeshFileReader(strInputOrigTriFileName.c_str());
	...
	MeshFileWriter polycubeTetMeshFileWriter(polycubeTriMesh.V, polycubeTriMesh.C, "polycube.tri.n.a.vtk", TRIANGLE);
